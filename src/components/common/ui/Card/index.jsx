...
const Card = ({ children, hover = true, className = "", variant = "default" }) => {
  const variants = {
    default: `
      ...
      shadow-sm shadow-gray-900/[0.02] dark:shadow-gray-900/15
    `,
    glass: `
      bg-white/50 dark:bg-gray-900/50
      backdrop-blur-xl 
      border border-white/15 dark:border-gray-700/25
      shadow-md shadow-gray-900/[0.04] dark:shadow-gray-900/20
    `,
    elevated: `
      bg-white dark:bg-gray-800
      border border-gray-200/70 dark:border-gray-700/70
      shadow-lg shadow-gray-900/[0.06] dark:shadow-gray-900/20
    `
  };
